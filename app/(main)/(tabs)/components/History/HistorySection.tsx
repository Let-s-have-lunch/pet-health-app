...
import MedicalHistorySection from "./components/History/MedicalHistorySection";
...
export default function HomeScreen() {
    ...
    const displayPets = isLoggedIn ? pets : [demoPet];
    ...
    return (
        ...
        <ScrollView className={twMerge(["flex-1"])}>
            {/* 🐶 상단: 동물 카드 영역 (팀원 원본) */}
            <PetCardSection pets={displayPets} />
            <AddPetCard onPress={handleAddPet} />
